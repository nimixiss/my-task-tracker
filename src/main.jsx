...
const noteThemes = [
  { cls: "note-theme-peach" },
  { cls: "note-theme-mint" },
  { cls: "note-theme-lavender" },
  { cls: "note-theme-sky" },
  { cls: "note-theme-lemon" },
  { cls: "note-theme-rose" },
  { cls: "note-theme-apricot" },
  { cls: "note-theme-lilac" },
  { cls: "note-theme-cloud" },
];
...
function normalizeNote(note){ return { id:createId(), text:"", createdAt:nowIso(), themeCls:noteThemes[0].cls, decor:"", ...note }; }
